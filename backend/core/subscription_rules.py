...
قیمت واقعی (silver_price/gold_price) از مدل SubscriptionPricing (اپ platform_ops) خونده می‌شه،
نه از اینجا؛ این فایل فقط محدودیت‌های عملکردی (نه مالی) رو نگه می‌داره.
"""
